...
public class ArmSubsystem extends SubsystemBase implements BlitzSubsystem {
    ...
    private final Command protectArmCommand;
    ...
    public Command rotateToCommand(double degrees) {
    ...
    public Command extendToCommand(double meters) {
    ...
    public Command levelArmCommand() {
